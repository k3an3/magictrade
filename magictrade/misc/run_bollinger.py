...
def cli():
    ...
    parser.add_argument('-q',
                        '--trade-queue',
                        help="Name of the magictrade queue to add trades to.")
    parser.add_argument('-d',
                        '--dry-run',
                        action="store_true",
                        help="Set the dry run flag to check for trade "
    ...
    parser.add_argument('-l',
                        ...
                        type=int,
                        default=1,
                        help="Allocation percentage for each trade")
    parser.add_argument(
        '-r',
        '--random-sleep',
        type=int,
    ...
    parser.add_argument(
        '-a',
        '--account-id',
        help='If set, will check existing trades to avoid securities '
        'with active trades.')
